...
/**
 * PDF document reader implementation using Poppler-Qt6
 * Provides full PDF support with text extraction and metadata access.
 */
...
private:
    ...
    // No page caching for now - will load pages on demand
